...
<nav>
	<ul class="nav topnav">
		...
		<li class="dropdown"><a href="#"><%=resource.getString("customer.menu.search")%>
				<i class="icon-angle-down"></i></a>
			<ul class="dropdown-menu">
				<li><a href=""><%=resource.getString("customer.menu.search.defect.byid")%></a></li>
				<li><a href=""><%=resource.getString("customer.menu.search.defect.keyword")%></a></li>
			</ul></li>
