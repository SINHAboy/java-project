<%@ page
	import="java.util.List, com.src.java.crm.dto.DesTable, com.src.java.crm.dto.Severity, com.src.java.crm.dto.User, com.src.java.crm.dto.GpsSimRelease, com.src.java.crm.dto.GpsModule "%>
<!DOCTYPE html>
<html lang="en">
