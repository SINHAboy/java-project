<%@ page
	...
	com.src.java.crm.dto.User, com.src.java.crm.dto.Comment, com.src.java.crm.dto.GpsSimRelease, com.src.java.crm.dto.GpsModule "%>
<!DOCTYPE html>
<html lang="en">
						...
						<form name="raisdefectform" action="viewDefectList.do"
							...
							<div class="row">
								...
								<div class="span3 form-group field">
									...
									<%
										List<GpsSimRelease> simReleaseList = (List<GpsSimRelease>) application.getAttribute("GpsSimReleaseList");

										for (GpsSimRelease g : simReleaseList) {
								...
								<div class="span3 form-group field">
									<%
										List<GpsModule> moduleList = (List<GpsModule>) application.getAttribute("GpsModuleList");

										for (GpsModule m : moduleList) {
							...
							<div class="row">
								...
								<div class="span3 form-group field">
									<select name="fixedinversion">
										<%
											simReleaseList = (List<GpsSimRelease>) application.getAttribute("GpsSimReleaseList");
