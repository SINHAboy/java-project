<%@ page
	...
	com.src.java.crm.dto.User, 
	com.src.java.crm.dto.GpsSimRelease, com.src.java.crm.dto.GpsModule, static com.src.java.crm.utilities.StringUtility.*, 
	static com.src.java.crm.utilities.GPSSimUtility.*"%>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="span12">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									<td>Description</td>
									<td>Raised By <% if(type != null && ! type.isEmpty()) { %> <a href="viewDefectList.do?order=customer"><i class="icon-caret-down icon-large"></i></a>&nbsp; <a
										href="viewDefectList.do?order=customer&by=desc"><i class="icon-caret-up icon-large"></i></a><%} %></td>
									<td>Severity</td>
									<td>Creation Date</td>
									<td>Status</td>
									<td>Module Name</td>
							...
							<tbody>
								...
								<tr>
									...
									<td><%=dt.getStatus()%></td>
									<td><%=getModuleName(dt.getModuleNameId(), (List<GpsModule>) application.getAttribute("GpsModuleList"))%></td>
								</tr>
								<%
									}
								%>
