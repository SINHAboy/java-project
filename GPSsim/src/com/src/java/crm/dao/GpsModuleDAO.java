...
public class GpsModuleDAO {
	private Connection con;

	public GpsModuleDAO(Connection con) {
		this.con = con;
	}

	public List<GpsModule> getAllModule() {
		List<GpsModule> moduleList = new ArrayList<GpsModule>();

		GpsModule module = null;
		try {
	...
	public GpsModule getModuleByName(String name) {
		GpsModule module = null;
		try {
