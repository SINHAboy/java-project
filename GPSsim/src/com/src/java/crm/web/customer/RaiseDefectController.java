package com.src.java.crm.web.customer;
...
import com.src.java.crm.services.GPSUserService;
...
public class RaiseDefectController extends HttpServlet {
	...
	public void doGet(HttpServletRequest rq, HttpServletResponse rs) throws ServletException, IOException {
		...
		List<GpsModuleVersionDetail> moduleVersionDetalList = (List<GpsModuleVersionDetail>) context.getAttribute("ModuleVersionDetalList");
		
		List<Float> versionList = new ArrayList<Float>();
		
		for(GpsModuleVersionDetail gmvd : moduleVersionDetalList) {
	...
	public void doPost(HttpServletRequest rq, HttpServletResponse rs) throws ServletException, IOException {
		...
		try {
			GPSUserService gpsUserService = new GPSUserService();
