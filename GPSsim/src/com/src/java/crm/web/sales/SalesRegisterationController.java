package com.src.java.crm.web.sales;
...
import com.src.java.crm.services.GPSCustomerService;

@SuppressWarnings("serial")
@WebServlet(urlPatterns = "/registerSalesProfile")
public class SalesRegisterationController extends HttpServlet {
	@Override
	public void doPost(HttpServletRequest rq, HttpServletResponse rs) throws ServletException, IOException {
		...
		try {
			...
			GPSCustomerService gPSCustomerService = new GPSCustomerService();
			// registerCustomer(user, customer)
			gPSCustomerService.registerSales(user, cust);
